...
final class LocationSearchViewController: UIViewController {
    ...
    /// If this view controller is being used to show matching locations based on a search, the value of this variable should be `true`. If this view controller is being used to simply show the list of all EFP locations, the value of this should variable be `false`. Defaults to `true`.
